...
chrome.runtime.sendMessage({ type: 'XMLHttpRequest', request: { url: "https://raw.githubusercontent.com/b2cktr2ck/Simple-Discord-Crypted/main/SimpleDiscordCrypt.user.js" } }, (result) => { //or chrome.runtime.getURL("SimpleDiscordCrypt.user.js")
	let script = document.createElement('script');
	script.textContent = `
(()=>{
